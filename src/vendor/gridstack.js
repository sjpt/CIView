    ...
    */
    ...
    GridStack.prototype._prepareElementsByNode = function(el, node) {
        ...
        var onEndMoving = function(event, ui) {
            ...
            if (event.type === "resizestop"){   
                ui.originalElement.trigger('resizefinished',ui);
            }
    ...
    let GridStackUI = GridStack;

    GridStackUI.Utils = Utils;
    GridStackUI.Engine = GridStackEngine;
    GridStackUI.GridStackDragDropPlugin = GridStackDragDropPlugin;
